...
if (strpos($_SERVER['PHP_SELF'], "dropdownTypeCircuits.php")) {
...
if (isset($_POST["circuittype"])) {
   ...
   if (isset($_POST['used']) && is_array($_POST['used']) && (count($_POST['used']) > 0)) {
      $query = "SELECT `id`
                ...
                WHERE `id` IN (" . implode(',', $_POST['used']) . ")
                      AND `plugin_circuits_circuittypes_id` = '" . $_POST["circuittype"] . "'";
   ...
   Dropdown::show('PluginCircuitsCircuit',
                  array('name'      => $_POST['myname'],
                        'used'      => $used,
                        'width'     => '50%',
                        'entity'    => $_POST['entity'],
                        'rand'      => $_POST['rand'],
                        'condition' => "glpi_plugin_circuits_circuits.plugin_circuits_circuittypes_id='" . $_POST["circuittype"] . "'"));
