...
if (isset($_POST["add"])) {
   ...
   //unlink circuits to items of glpi from the items form
} else if (isset($_POST["deletecircuits"])) {
   ...
   if ($plugin->isActivated("environment")) {
      Html::header(PluginCircuitsCircuit::getTypeName(2),
                   '', "assets", "pluginenvironmentdisplay", "circuits");
   } else {
      Html::header(PluginCircuitsCircuit::getTypeName(2), '', "assets", "plugincircuitsmenu");
   }
   //load circuits form
   $web->display($_GET);
