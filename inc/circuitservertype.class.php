...
/**
 * Class PluginCircuitsCircuitServerType
 */
class PluginCircuitsCircuitServerType extends CommonDropdown {
   ...
   static function getTypeName($nb = 0) {
      ...
      return _n('Type of treatment server', 'Types of treatment server', $nb, 'circuits');
   }
}