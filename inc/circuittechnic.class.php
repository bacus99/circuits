...
/**
 * Class PluginCircuitsCircuitTechnic
 */
class PluginCircuitsCircuitTechnic extends CommonDropdown {
   ...
   static function getTypeName($nb = 0) {
      ...
      return _n('Language of treatment', 'Languages of treatment', $nb, 'circuits');
   }
}